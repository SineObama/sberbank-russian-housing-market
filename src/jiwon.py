...
# online different_result 0.31039


## from https://www.kaggle.com/aharless/jiwon-small-improvements-for-magic-number-results
## -------------------------------
...
# Parameters
prediction_stderr = 0.0065 #  assumed standard error of predictions
                          #  (smaller values make output closer to input)
train_test_logmean_diff = 0.07 # assumed shift used to adjust frequencies for time trend
